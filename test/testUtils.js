...
test("json to query simple", toQuery, { abc: "def", a: 4 }, "abc=def&a=4");

test(
  "json to query with dupes",
  toQuery,
...
test(
  "surt with query args sorted, lowercase",
  testSURT,
